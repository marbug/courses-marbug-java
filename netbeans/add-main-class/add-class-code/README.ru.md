...
**"Hello, World"** (читается похоже на "хеллОу, вЁлд") и означает "Здравствуй, Мир". Мы - культурные хулиганы.

Вот это и есть то, что мы будем говорить в микрофон или писать на заборе. Причём написано оно в кавычках, но "прозвучит" или "будет написано" без них. Ну и вместо "бииииип" или "кляксы" у нас будет кое-что другое. Об этом читайте далее.
